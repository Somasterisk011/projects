...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const careerStats = document.querySelector(".career-statistics");
  if (careerStats) observer.observe(careerStats);
});
...
document.addEventListener("DOMContentLoaded", () => {
  setTimeout(() => {
    ...
    // ✅ STOP if confetti is not available
...
const consultationStatus = document.getElementById("formStatus");
...
if (consultationForm) {
  consultationForm.addEventListener("submit", async function (e) {
    ...
    if (consultationStatus) consultationStatus.style.display = "none";
    ...
    try {
      ...
      if (response.ok) {
        ...
        if (consultationStatus) {
          consultationStatus.className = "form-status success";
      ...
      if (consultationStatus) {
        consultationStatus.className = "form-status error";
        consultationStatus.innerText =
          "Something went wrong. Please try again.";
        consultationStatus.style.display = "block";
      }

      // Restore everything after error
      setTimeout(() => {
        if (consultationStatus) consultationStatus.style.display = "none";
...
//mobile version data tab for service pages

(function () {
  document.addEventListener("DOMContentLoaded", function () {
    const section = document.getElementById("service-practice-section");
    if (!section || typeof bootstrap === "undefined") return;

    const dropdown = section.querySelector(".service-practice-dropdown");
    const button = section.querySelector(".service-practice-btn");
    const items = section.querySelectorAll(".service-practice-menu li");
    ...
    items.forEach((item) => {
      item.addEventListener("click", function () {
        ...
        button.innerHTML =
          this.textContent + ' <span class="service-practice-arrow">▾</span>';
...
//for practice area in mobile version
(function () {
  document.addEventListener("DOMContentLoaded", function () {
    const section = document.getElementById("practice-area-section");
    if (!section) return;

    const dropdown = section.querySelector(".practice-area-dropdown");
    const button = section.querySelector(".practice-area-btn");
    const items = section.querySelectorAll(".practice-area-menu li");
    ...
    items.forEach((item) => {
      item.addEventListener("click", function () {
        ...
        button.innerHTML =
          this.textContent + ' <span class="practice-area-arrow">▾</span>';
        dropdown.classList.remove("is-open");
